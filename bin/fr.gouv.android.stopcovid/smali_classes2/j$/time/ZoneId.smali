...
.method public static C(Lj$/time/temporal/TemporalAccessor;)Lj$/time/ZoneId;
    .locals 3
...
.method public static F(Ljava/lang/String;)Lj$/time/ZoneId;
    ...
    :cond_2
    invoke-static {p0, v1}, Lj$/time/n;->H(Ljava/lang/String;Z)Lj$/time/n;
...
.method private static G(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    ...
    invoke-static {p0, p2}, Lj$/time/n;->H(Ljava/lang/String;Z)Lj$/time/n;
    ...
    invoke-direct {p2, p0, p1}, Lj$/time/g;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
# virtual methods
.method public abstract D()Lj$/time/zone/c;
.end method
...
.method public normalized()Lj$/time/ZoneId;
    ...
    invoke-virtual {v0}, Lj$/time/zone/c;->h()Z

    move-result v1

    if-eqz v1, :cond_0

    sget-object v1, Lj$/time/Instant;->a:Lj$/time/Instant;
