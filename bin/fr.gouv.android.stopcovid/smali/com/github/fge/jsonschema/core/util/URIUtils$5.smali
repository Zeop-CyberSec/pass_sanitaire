.class public Lcom/github/fge/jsonschema/core/util/URIUtils$5;
...
.method public bridge synthetic check(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/github/fge/jsonschema/core/util/URIUtils$5;->check(Ljava/net/URI;)V
...
.method public check(Ljava/net/URI;)V
    ...
    const-string/jumbo v5, "uriChecks.fragmentNotNull"
    ...
    const-string/jumbo v5, "uriChecks.queryNotNull"
    ...
    const-string/jumbo v5, "uriChecks.noPath"
    ...
    const-string/jumbo p1, "uriChecks.noEndingSlash"
